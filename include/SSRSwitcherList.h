...
#define SSRSwitcherSwitchList \
    SSRSwitcherSwitch(SSR1,         SSR_Switch_Ovp, 10000,      2000,       Shunt,  MinCompare, -1,     -1,     -0.01,  -0.01) \
    SSRSwitcherSwitch(SSR1,         SSR_Switch_Lvp, 10000,      2000,       Shunt,  MaxCompare, 1,      1,      0.01,   0.01)
// clang-format on