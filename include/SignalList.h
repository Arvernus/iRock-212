...
#define SignalList \
  ...
  Signal(SSR_Switch,          DigitalOutput,        "",   1.0,    0.0,      0,    10,     0,        false,  false,  "Drives SSR engine") \
  Signal(SSR_Switch_Ovp,      DigitalOutput,        "",   1.0,    0.0,      0,    10,     0,        false,  false,  "Drives SSR engine") \
  Signal(SSR_Switch_Lvp,      DigitalOutput,        "",   1.0,    0.0,      0,    10,     0,        false,  false,  "Drives SSR engine") \
