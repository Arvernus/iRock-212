...
#define SignalList \
  ...
  Signal(AD_Shunt,      AnalogDiffInput,  "A",  180.0,  -0.00017, 0,    1,      1,        true,   false,  "Sum of the current running in or out of the battery") \
  ...
  Signal(MP_C5,         AnalogInput,      "V",  1.0,    0.0,      0,    3,      10,       true,   false,  "Electric potential of the battery cell 5") \
  Signal(MP_C6,         AnalogInput,      "V",  1.0,    0.0,      0,    3,      10,       true,   false,  "Electric potential of the battery cell 6") \
  Signal(MP_C7,         AnalogInput,      "V",  1.0,    0.0,      0,    3,      10,       true,   false,  "Electric potential of the battery cell 7") \
  Signal(MP_C8,         AnalogInput,      "V",  1.0,    0.0,      0,    3,      10,       true,   false,  "Electric potential of the battery cell 8") \
  ...
  Signal(C_discon,      DigitalOutput,    "",   1.0,    0.0,      0,    10,     0,        false,  false,  "Disconnects the charger on the PCB - True means charger is disconnected") \
  Signal(L_discon,      DigitalOutput,    "",   1.0,    0.0,      0,    10,     0,        false,  false,  "Disconnects the load on the PCB - True means load is disconnected") \
